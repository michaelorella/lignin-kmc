...
DEF_E_A_KCAL_MOL = {C5O4: {(0, 0): {(MONOMER, MONOMER): 11.2, (MONOMER, OLIGOMER): 14.6, (OLIGOMER, MONOMER): 14.6,
                                    (OLIGOMER, OLIGOMER): 4.4},
                           (1, 0): {(MONOMER, MONOMER): 10.9, (MONOMER, OLIGOMER): 14.6, (OLIGOMER, MONOMER): 14.6,
                                    (OLIGOMER, OLIGOMER): 4.4},
                           (2, 2): {(MONOMER, MONOMER): 11.9, (MONOMER, OLIGOMER): 11.9,
                                    (OLIGOMER, MONOMER): 11.9, (OLIGOMER, OLIGOMER): 11.9}},
                    C5C5: {(0, 0): {(MONOMER, MONOMER): 12.5, (MONOMER, OLIGOMER): 15.6, (OLIGOMER, MONOMER): 15.6,
                                    (OLIGOMER, OLIGOMER): 3.8},
                    ...
                    B5: {(0, 0): {(MONOMER, MONOMER): 5.5, (MONOMER, OLIGOMER): 5.8, (OLIGOMER, MONOMER): 5.8,
                         ...
                         (0, 1): {(MONOMER, MONOMER): 5.5, (MONOMER, OLIGOMER): 5.8, (OLIGOMER, MONOMER): 5.8,
                                  (OLIGOMER, OLIGOMER): 5.8},
                         (2, 2): {(MONOMER, MONOMER): 1.9, (MONOMER, OLIGOMER): 5.8,
                    ...
                    BB: {(0, 0): {(MONOMER, MONOMER): 5.2, (MONOMER, OLIGOMER): 5.2, (OLIGOMER, MONOMER): 5.2,
                         ...
                         (1, 1): {(MONOMER, MONOMER): 5.2, (MONOMER, OLIGOMER): 5.2, (OLIGOMER, MONOMER): 5.2,
                                  (OLIGOMER, OLIGOMER): 5.2},
                         (2, 2): {(MONOMER, MONOMER): 7.2, (MONOMER, OLIGOMER): 7.2,
                    ...
                    AO4: {(0, 0): {(MONOMER, MONOMER): 20.7, (MONOMER, OLIGOMER): 20.7,
                          ...
                          (2, 2): {(MONOMER, MONOMER): 20.7, (MONOMER, OLIGOMER): 20.7,
                                   (OLIGOMER, MONOMER): 20.7, (OLIGOMER, OLIGOMER): 20.7}},
                    B1: {(0, 0): {(MONOMER, OLIGOMER): 9.6, (OLIGOMER, MONOMER): 9.6, (OLIGOMER, OLIGOMER): 9.6},
                         (1, 0): {(MONOMER, OLIGOMER): 11.7, (OLIGOMER, MONOMER): 11.7, (OLIGOMER, OLIGOMER): 11.7},
                         (0, 1): {(MONOMER, OLIGOMER): 10.7, (OLIGOMER, MONOMER): 10.7, (OLIGOMER, OLIGOMER): 10.7},
                         (1, 1): {(MONOMER, OLIGOMER): 11.9, (OLIGOMER, MONOMER): 11.9, (OLIGOMER, OLIGOMER): 11.9},
                         (2, 2): {(MONOMER, OLIGOMER): 9.6, (OLIGOMER, MONOMER): 9.6, (OLIGOMER, OLIGOMER): 9.6}},
...
# These were calculated at 298 K from the DEF_E_A_KCAL_MOL. Note: there is *no* standard state correction
